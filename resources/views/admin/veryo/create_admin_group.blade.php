                        ...
                        <div class="card shadow mb-4">
                            <form class="row g-3" style="margin: 2% 16%">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name='tex' id="tex" placeholder="รายละเอียด"
                                        rows="3"></textarea>
                                </div>
                                ...
                                <div class="col-sm-2 text-end">
                                    <select name="status1" onchange="create()" aria-controls="DataTables_Table_0"
                                ...
                                <div class="row">
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="g1" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="e1" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="e2" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="e3" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="e4" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="e5" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="s1" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="s2" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="s3" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="s4" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="s5" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="s6" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="en1" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="en2" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="en3" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="en4" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="pd1" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="a1" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                    ...
                                    <div class="row" style="color:rgb(67, 66, 66); font-size: 14px;margin-top: 1%">
                                        ...
                                        <div class="col-sm-2 text-end">
                                            <select name="a2" onchange="create()" aria-controls="DataTables_Table_0"
                                                class="form-select form-select-sm">
                                                <option value="2" selected="">ดู/แก้ไข</option>
                                                <option value="1">ดูอย่างเดียว</option>
                                                <option value="0">ปิดการมองเห็น</option>
                                ...
                                <div class="col-12" style="margin-top:3%;">
                                    <button type="button" class="btn text-white"
                                        style="width:130PX;background-color: #FFA200;" onclick="create()">Saves</button>
