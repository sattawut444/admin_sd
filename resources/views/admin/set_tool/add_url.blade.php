                ...
                <div class="container  mt-3" style="background-color: white; padding:2%; border-radius: 10px;">
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <h1 class="h3 mb-0 text-gray-800" style="color: rgb(0, 0, 0);">Add URL</h1>
                            {{-- <div>
                        ...
                        <div class="card shadow mb-4">
                            <form class="row g-3" style="margin: 2% 4%">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="category" class="form-control" id="url" value="{{$category}}">
                                </div>
                                <div class="col-12">
                                    <label for="inputAddress2" class="form-label">Type</label>
                                    <input type="text" name="type" class="form-control" id="url" placeholder="type">
                                </div>
                                <div class="col-12">
