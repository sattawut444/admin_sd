            ...
            <main class=" pt-4  mdb-docs-layout" style="width: 100%;padding:2%; height:100vh; background-color: rgb(255, 255, 255);" >
                ...
                <div class="container  mt-3" style="background-color: white; padding:2%; border-radius: 10px;">
                    <div class="container-fluid">
                        <h1 class="h3 mb-0 text-gray-800" style="font-size: 40px;color: rgb(2, 4, 52);">Corporate Citizenship & Philanthropy</h1><br>
                       
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800" style="color:rgb(2, 4, 52);">เอกสารดาวน์โหลด</h1>
                            <div>
                                <a href="{{url('/admin/create_pdf?category=social&type=citizenship_philanthropy')}}">
...
function GetAction_plan(){
        ...
        let type = 'citizenship_philanthropy';
        let category = 'social';
    $.ajaxSetup({
        headers: {
    ...
    $.ajax({
        ...
        success: function(result) { 
            ...
            console.log(value)
                    if(value.type == 'citizenship_philanthropy')
                        html_3 += `
                            <tr data="${value.id}">
                              <th scope="row">
