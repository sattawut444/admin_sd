            ...
            <main class=" pt-4  mdb-docs-layout" style="width: 100%;padding:2%; height:100vh; background-color: rgb(255, 255, 255);" >
                ...
                <div class="container  mt-3 shadow-lg" style="background-color: white; padding:2%; border-radius: 10px; ">
                    <div class="container-fluid">
                        <h1 class="h3 mb-0 text-gray-800" style="font-size: 40px;color: rgb(2, 4, 52);">Contribution to External <br>Organization and Associations</h1><br>
                       
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800" style="color:rgb(2, 4, 52);">เอกสารดาวน์โหลด</h1>
                            <div>
                                <a href="{{url('/admin/create_pdf?category=economic&type=contribution_to_external_organization_and_associations')}}">
                                    <button class="ripple ripple-surface btn btn-rounded" style="color: white; background-color: rgb(2, 203, 52); padding:auto;" role="button"
                                        fdprocessedid="z4lstl" >เพิ่มเอกสารดาวน์โหลด</button>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header d-flex   justify-content-between" style="background-color: rgb(7, 28, 85);">
                                ...
                                <div class="d-flex "style="margin: auto 0%">
                                    {{-- <div class="ms-3">
                                        <select name="order_by" onchange="GetAction_plan()" aria-controls="DataTables_Table_0"
                                            class="form-select form-select-sm ">
                                            <option value="asc" selected="">ลำดับก่อน - หลัง</option>
                                            <option value="desc">ลำดับหลัง - ก่อน</option>
                                        </select>
                                    @csrf
                                    </div>
                                    <div class="ms-3">
                                        <select name="limit_data" onchange="GetAction_plan()" aria-controls="DataTables_Table_0"
                                            class="form-select form-select-sm">
                            ...
                            <div class="card-body">
                                <div class="mb-3" >
                                    ...
                                    {{-- <div class="input-group mb-3">
                                        <input type="text" class="form-control " placeholder="ค้นหา" aria-label="ค้นหา" aria-describedby="basic-addon2">
                                        <div class="input-group-append btn-primary" >
                                          <button class="btn btn-outline-secondary text-white" onchange="GetAction_plan()" type="button">search</button>
                                        </div>
                                      </div> --}}
                                </div>
...
function GetAction_plan(){
        ...
        let type = 'contribution_to_external_organization_and_associations';
    ...
    $.ajax({
        ...
        success: function(result) { 
            ...
            console.log(value)
                    if(value.type == 'contribution_to_external_organization_and_associations')
                        html_3 += `
                            <tr data="${value.id}">
                              <th scope="row">
