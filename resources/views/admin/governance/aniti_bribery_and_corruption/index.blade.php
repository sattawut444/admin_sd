            ...
            <main class=" pt-4  mdb-docs-layout" style="width: 100%;padding:2%; height:100vh; background-color: rgb(255, 255, 255);" >
                ...
                <div class="container  mt-3 shadow-lg" style="background-color: white; padding:2%; border-radius: 10px; ">
                    <div class="container-fluid">
                        <h1 class="h3 mb-0 text-gray-800" style="font-size: 40px;color: rgb(2, 4, 52);">Aniti Bribery <br>and Corruption</h1><br>
                       
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800" style="color:rgb(2, 4, 52);">เอกสารดาวน์โหลด</h1>
                            <div>
                                <a href="{{url('/admin/create_pdf?category=governance&type=aniti_bribery_and_corruption')}}">
...
function GetAction_plan(){
        ...
        let type = 'aniti_bribery_and_corruption';
    ...
    $.ajax({
        ...
        success: function(result) { 
            ...
            console.log(value)
                    if(value.type == 'aniti_bribery_and_corruption')
                        html_3 += `
                            <tr data="${value.id}">
                              <th scope="row">
