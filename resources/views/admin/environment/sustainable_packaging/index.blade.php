                ...
                <div class="container  mt-3 shadow-lg"
                    ...
                    <div class="container  mt-3 shadow-lg"
                        ...
                        <div class="container-fluid">
                            <h1 class="h3 mb-0 text-gray-800" style="font-size: 40px;color: rgb(2, 4, 52);">Sustainable
                                Packaging</h1><br>
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                ...
                                <div>
                                    <a
                                        href="{{url('/admin/create_pdf?category=environment&type=sustainable_packaging')}}">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-borderless" style="border-radius: 10px;">
                                        <thead style="border-radius: 10px;">
                                            <tr
                                                style="border-radius: 10px;background-color: rgba(218, 214, 214, 0.471);">
...
function GetAction_plan(){
        ...
        let type = 'sustainable_packaging';
    ...
    $.ajax({
        ...
        success: function(result) { 
            ...
            console.log(value)
                    if(value.type == 'sustainable_packaging')
                        html_3 += `
                            <tr data="${value.id}">
                              <th scope="row">
