            ...
            <main class=" pt-4  mdb-docs-layout"
                ...
                <div class="container  mt-3 shadow-lg"
                    ...
                    <div class="container-fluid">
                        <h1 class="h3 mb-0 text-gray-800" style="font-size: 40px;color: rgb(2, 4, 52);">Water Wastewater
                        </h1><br>

                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800" style="color:rgb(2, 4, 52);">เอกสารดาวน์โหลด</h1>
                            <div>
                                <a href="{{url('/admin/create_pdf?category=environment&type=water_wastewater')}}">
...
function GetAction_plan(){
    ...
    $.ajax({
        ...
        success: function(result) { 
            ...
            console.log(value)
                    if(value.type == 'water_wastewater')
                        html_3 += `
                            <tr data="${value.id}">
                              <th scope="row">
